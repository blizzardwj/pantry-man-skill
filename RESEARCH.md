...
- 状态: **已决策（实例级 exemplar 消费），待实施**（决策见 DECISIONS.md [2026-08-28]；数据结构/消费机制待细化）
- 提出: 2026-08-28（见 IDEAS.md「研究问题：用户反馈的消费语义」）
...
6. **消费方式先于存储形态**——先定义「这道菜如何被下一次搭配消费」，再定它落哪个文件/字段（2026-08-28 用户明确要求）
