...
- 状态: **planned**（2026-08-05 设计定稿，待实施）
- 日期: 2026-08-05
...
- 备注: 2026-08-05 提出并完成设计——完整调研见 [RESEARCH.md](RESEARCH.md)（4 类方案、三问映射、关键约束、数据结构/触发规则/复用规则定稿）；配套决策见 DECISIONS.md [2026-08-05] RQ-5 反馈机制设计；待实施
